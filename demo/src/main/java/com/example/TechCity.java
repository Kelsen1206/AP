...
public class TechCity {
    ...
    public void createLevel() throws IOException {
        ...
        // Use a ScrollPane to allow scrolling
        ScrollPane scrollPane = new ScrollPane(gameWorld);
        scrollPane.setPannable(true);
        scrollPane.setHbarPolicy(ScrollPane.ScrollBarPolicy.NEVER);
        scrollPane.setVbarPolicy(ScrollPane.ScrollBarPolicy.NEVER);
        scrollPane.setFitToHeight(true);

        // Set the content of the scene to the ScrollPane
        scene = new Scene(scrollPane, 1000, 650);
    }
    ...
    public void updateView(double playerX) {
        double scrollX = playerX - scene.getWidth() / 2;
        scrollX = Math.max(0, Math.min(scrollX, gameWorld.getWidth() - scene.getWidth()));
        gameWorld.setLayoutX(-scrollX);
    }
}
